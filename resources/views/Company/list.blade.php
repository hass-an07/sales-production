                ...
                <form action="{{ route('company.index') }}" method="GET">
                    <div class="card-header">
                        ...
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route('company.index') }}'"
                            ...
                            @if ($company->isNotEmpty())
                                @foreach ($company as $item)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <!-- Edit Button -->
                                            <a href="{{ route('company.edit', $item->id) }}" class="mr-2">
                                            ...
                                            <!-- Delete Button -->
                                            <form action="{{ route('company.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item?');">
                                                @csrf
                                                @method('DELETE')
