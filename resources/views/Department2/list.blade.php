...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card">
            <form action="{{ route('department2.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-header ">
                    ...
                    <div class="card-title col-6">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('dept_name') }}" name="dept_name"
                                id="dept_name" class="form-control" placeholder="Department Name">
                        ...
                        @if ($department->isNotEmpty())
                            @foreach ($department as $item)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a href="{{ route('department2.edit', $item->id) }}">
                                            ...
                                            <form action="{{ route('department2.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item?');">
                                                @csrf
                                                @method('DELETE')
