                ...
                <div class="themeholy-invoice invoice_style4">
                    <div class="download-inner" id="download_section">
                        <div class="card-body table-responsive p-0">
                            <h3 class="text-center" style="border: 2px solid black">Goods Received Note</h3>
                            <h4 class="text-center" style="border: 2px solid black">{{ $grn->supplier_id}}</h4>
                            <div class="" style="border: 2px solid black; display: flex; justify-content: space-between">
                                <div>
                                    <h5>Grn Number: {{ $grn->grn_no }}</h5>
                                    <h5>Company :   {{ $grn->company->company_name  }}</h5>
                                    <h5>Invoice :   {{ $grn->invoice_no  }}</h5>
                                </div>
                                <div>
                                    <h5>Date: {{ $grn->grn_date }}</h5>
                            ...
                            <table class="table table-hover text-nowrap my-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3"></td>
                                        <td colspan="2"><h5>Grass Total: {{$grn->total_amount}}</h5></td>
                                    </tr> 
                                </tbody>
                            </table>
