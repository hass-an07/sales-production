...
@section('content')
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('outward.index') }}" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('outward.update', $outward->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="returnable" {{ $outward->status == 'returnable' ? 'selected' : '' }}>Returnable</option>
                                        <option value="permanent" {{ $outward->status == 'permanent' ? 'selected' : '' }}>Permanent</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="outward" id="outward" class="form-control" 
                                           value="{{ old('outward', $outward->outward) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="g_pass_no" id="g_pass_no" class="form-control" 
                                           value="{{ old('g_pass_no', $outward->g_pass_no) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="outward_no" id="outward_no" class="form-control" 
                                           value="{{ old('outward_no', $outward->outward_no) }}" placeholder="GRN NO">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" value="{{ old('time', $outward->time) }}" name="time" id="time"
                                        class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="vehicle" value="{{ old('vehicle', $outward->vehicle) }}" id="vehicle" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="worker_id" id="worker_id" class="form-control">
                                        ...
                                        @foreach ($supplier as $item)
                                            <option value="{{ $item->id }}" {{ $outward->worker_id == $item->id ? 'selected' : '' }}>{{$item->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="through" id="through" class="form-control" value="{{ old('through', $outward->through) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="dept_id" id="dept_id" class="form-control">
                                        ...
                                        @foreach ($departments as $item)
                                            <option value="{{ $item->id }}" {{ $outward->dept_id == $item->id ? 'selected' : '' }}>{{$item->dept_name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="materialType_id" id="materialType_id" class="form-control material-type">
                                        ...
                                        @foreach ($materialTypes as $materialType)
                                            <option value="{{ $materialType->id }}" {{ $outward->materialType_id == $materialType->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="qty" id="qty" class="form-control" value="{{ old('qty', $outward->qty) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ Auth::user()->name }}" name="username" id="username" class="form-control" readonly>
...
<script>
    $(document).ready(function () {
        ...
        // Pre-load materials and units based on the selected material type
        var initialMaterialTypeId = $('#materialType_id').val();
        if (initialMaterialTypeId) {
            loadMaterialsAndUnits(initialMaterialTypeId);
        }
    });
</script>
@endsection
