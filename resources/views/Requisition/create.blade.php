        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('requisition.index') }}" class="btn btn-primary">View</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" value="" name="date" id="worker_code"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="" name="requisition" id="requisition"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ old('reciver') }}" name="reciver" id="reciver"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" value="{{ old('total') }}" name="total" id="total"
