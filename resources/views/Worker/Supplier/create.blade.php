                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="dept_id" id="dept_id" class="form-control">
                                    ...
                                    <option value="{{ $department->id }}" {{ old('dept_id')==$department->id ?
                                        'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ old('reference') }}" name="reference" id="reference"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" value="{{ old('contact') }}" name="contact" id="contact"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" value="{{ old('address') }}" name="address" id="address"
