...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Worker/Supplier</h1>
            </div>
            <div class="col-sm-6 text-right">
                <a href="{{route('worker.create')}}" class="btn btn-primary">Add Worker</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        ...
        <div class="card">
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                    <a href="{{route('worker.edit',$item->id)}}">
                                        <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                        </svg></a>
                                        <form action="{{ route('worker.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item?');">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="card-footer clearfix">
                {{ $worker->links('pagination::bootstrap-5') }}
