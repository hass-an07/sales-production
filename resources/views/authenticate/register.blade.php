            ...
            <div class="card-body">
                ...
                <form action="{{ route('account.processregister') }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" value="{{old('name')}}" name="name" id="name" class="form-control @error('name')is-invalid
                    ...
                    @enderror
                    <div class="input-group mb-3">
                        <input type="password" name="password_confirmation" id="password" class="form-control @error('password')is-invalid
