                ...
                <form action="{{ route('product.index') }}" method="GET">
                    <div class="card-header">
                        ...
                        <div class="card-title">
                            ...
                            <a href="{{route('role.index')}}" class="btn btn-primary">Role</a>
                            <a href="{{route('permission.index')}}" class="btn btn-primary">Permissions</a>
                        </div>
                        {{-- <div class="card-title">
                                ...
                                @foreach ($users as $item)
                                    <tr>
                                       ...
                                       <td> @foreach ($item->getRoleNames() as $role)
                                        <label for="" class="badge bg-primary mx-2">{{$role}}</label>
                                    @endforeach</td>
